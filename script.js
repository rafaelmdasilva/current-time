...
buttonEle.addEventListener('click', () => {
	...
	setTimeout(() => {
		clockEle.classList.remove('scaleDown', 'scaleUp');
	}, 200);
});
...
function refreshClock() {
	...
	setTimeout(() => {
		clockEle.classList.remove('wiggle');
	}, 200);
...
function morning() {
	...
	mainEle.style.background =
		'linear-gradient(225deg, rgba(135,207,235,1) 0%, rgba(248,219,123,1) 100%)';
	imageEle.src = morningIMG;
}
function afternoon() {
	greetEle.textContent = 'Good afternoon';
	mainEle.style.background =
		'linear-gradient(180deg, rgba(135,207,235,1) 0%, rgba(255,255,255,1) 100%)';
	imageEle.src = afternoonIMG;
}
function evening() {
	greetEle.textContent = 'Good evening';
	mainEle.style.background =
		'linear-gradient(125deg, rgba(135,207,235,1) 0%, rgba(255,68,0,1) 100%)';
	imageEle.src = eveningIMG;
}
function night() {
	greetEle.textContent = 'Good night';
	mainEle.style.background =
		'linear-gradient(180deg, rgba(35, 35, 71,1) 0%, rgba(0,0,0,1) 100%)';
